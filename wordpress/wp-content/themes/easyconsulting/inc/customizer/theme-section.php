...
$wp_customize->add_panel( 'theme_option_panel',
	array(
	'title'      => __( 'Theme Options', 'easyconsulting' ),
	'priority'   => 100,
...
$wp_customize->add_section('section_page_title', 
	array(    
	'title'       => __('Page Title', 'easyconsulting'),
...
$wp_customize->add_section('section_sidebar_layout', array(    
	'title'       => __('Sidebar Layout', 'easyconsulting'),
	'panel'       => 'theme_option_panel'    
));
...
$wp_customize->add_setting('theme_options[layout_options_blog]', 
	...
	'type'              => 'theme_mod',
	'capability'        => 'edit_theme_options',
	'sanitize_callback' => 'easyconsulting_sanitize_select'
	)
);

$wp_customize->add_control(new easyconsulting_Image_Radio_Control($wp_customize, 'theme_options[layout_options_blog]', 
	array(		
	'label' 	=> __('Blog Layout', 'easyconsulting'),
...
$wp_customize->add_control(new easyconsulting_Image_Radio_Control($wp_customize, 'theme_options[layout_options_archive]', 
	array(		
	'label' 	=> __('Archive Layout', 'easyconsulting'),
	'section' 	=> 'section_sidebar_layout',
...
$wp_customize->add_control(new easyconsulting_Image_Radio_Control($wp_customize, 'theme_options[layout_options_page]', 
	array(		
	'label' 	=> __('Page Layout', 'easyconsulting'),
	'section' 	=> 'section_sidebar_layout',
...
$wp_customize->add_control(new easyconsulting_Image_Radio_Control($wp_customize, 'theme_options[layout_options_single]', 
	array(		
	'label' 	=> __('Single Post Layout', 'easyconsulting'),
	'section' 	=> 'section_sidebar_layout',
...
$wp_customize->add_section('section_excerpt_length', 
	array(    
	'title'       => __('Excerpt Length', 'easyconsulting'),
	'panel'       => 'theme_option_panel'    
	)
);
...
$wp_customize->add_setting( 'theme_options[excerpt_length]', array(
	...
	'sanitize_callback' => 'easyconsulting_sanitize_number_range',
) );
$wp_customize->add_control( 'theme_options[excerpt_length]', array(
	'label'       => esc_html__( 'Excerpt Length', 'easyconsulting' ),
...
$wp_customize->add_section('section_blog_setting', 
	array(    
	'title'       => __('Blog / Archive Settings', 'easyconsulting'),
	'panel'       => 'theme_option_panel'    
	)
);
...
$wp_customize->add_setting( 'theme_options[readmore_text]',
	...
	'capability'        => 'edit_theme_options',
	'sanitize_callback' => 'easyconsulting_sanitize_textarea_content',
	'transport'         => 'refresh',
	)
);
...
$wp_customize->add_control( 'theme_options[readmore_text]',
	array(
	'label'    => __( 'Button Label', 'easyconsulting' ),
...
$wp_customize->add_section('section_footer', 
	array(    
	'title'       => __('Footer Setting', 'easyconsulting'),
	'panel'       => 'theme_option_panel'    
	)
);
...
$wp_customize->add_control( 'theme_options[copyright_text]',
	array(
	'label'    => __( 'Copyright Text', 'easyconsulting' ),
...
$wp_customize->add_control( 'theme_options[show_blog_posts_image]', array(
	'label'              => esc_html__( 'Display Image', 'easyconsulting' ),
	'section'            => 'section_blog_setting',
	'type'               => 'select',
	'choices' 	         => array(		
		'image-enable' 	 => 'Yes',						
...
$wp_customize->add_control( 'theme_options[show_blog_posts_category]', array(
	'label'              => esc_html__( 'Display Category', 'easyconsulting' ),
	'section'            => 'section_blog_setting',
	'type'               => 'select',
	'choices' 	         => array(		
		'category-enable' 	 => 'Yes',						
...
$wp_customize->add_control( 'theme_options[show_blog_posts_title]', array(
	'label'              => esc_html__( 'Display Title', 'easyconsulting' ),
	'section'            => 'section_blog_setting',
	'type'               => 'select',
	'choices' 	         => array(		
		'title-enable' 	 => 'Yes',						
...
$wp_customize->add_control( 'theme_options[show_blog_posts_content]', array(
	'label'       => esc_html__( 'Display Content', 'easyconsulting' ),
	'section'     => 'section_blog_setting',
	'type'        => 'select',
	'choices' 	  => array(		
		'content-enable' 	=> 'Yes',						
...
$wp_customize->add_control( 'theme_options[show_blog_posts_button]', array(
	'label'       => esc_html__( 'Display Button', 'easyconsulting' ),
	'section'     => 'section_blog_setting',
	'type'        => 'select',
	'choices' 	  => array(		
		'button-enable' 	=> 'Yes',						
...
$wp_customize->add_section('section_typography', 
	array(  
    'capability'  => 'edit_theme_options',  
	'title'       => __('Global Typography', 'easyconsulting'),
	'panel'       => 'theme_option_panel'    
	)
);
...
$wp_customize->add_control( 'theme_options[h1_font_size]', array(
	'label'       => esc_html__( 'H1 Font Size (Default: 52)', 'easyconsulting' ),
...
$wp_customize->add_control( 'theme_options[h2_font_size]', array(
	'label'       => esc_html__( 'H2 Font Size (Default: 42)', 'easyconsulting' ),
	'section'     => 'section_typography',
	'type'        => 'number',
	'input_attrs' => array( 'min' => 1, 'max' => 200, 'style' => 'width: 80px;' ),
) );
...
$wp_customize->add_control( 'theme_options[h3_font_size]', array(
	'label'       => esc_html__( 'H3 Font Size (Default: 32)', 'easyconsulting' ),
	'section'     => 'section_typography',
	'type'        => 'number',
	'input_attrs' => array( 'min' => 1, 'max' => 200, 'style' => 'width: 80px;' ),
) );
...
$wp_customize->add_control( 'theme_options[h4_font_size]', array(
	'label'       => esc_html__( 'H4 Font Size (Default: 22)', 'easyconsulting' ),
	'section'     => 'section_typography',
	'type'        => 'number',
	'input_attrs' => array( 'min' => 1, 'max' => 200, 'style' => 'width: 80px;' ),
) );
...
$wp_customize->add_control( 'theme_options[h5_font_size]', array(
	'label'       => esc_html__( 'H5 Font Size (Default: 18)', 'easyconsulting' ),
	'section'     => 'section_typography',
	'type'        => 'number',
	'input_attrs' => array( 'min' => 1, 'max' => 200, 'style' => 'width: 80px;' ),
) );
...
$wp_customize->add_control( 'theme_options[h6_font_size]', array(
	'label'       => esc_html__( 'H6 Font Size (Default: 16)', 'easyconsulting' ),
	'section'     => 'section_typography',
	'type'        => 'number',
	'input_attrs' => array( 'min' => 1, 'max' => 200, 'style' => 'width: 80px;' ),
) );
...
$wp_customize->add_control( 'theme_options[body_font_size]', array(
	'label'       => esc_html__( 'Body Font Size (Default: 16)', 'easyconsulting' ),
	'section'     => 'section_typography',
	'type'        => 'number',
	'input_attrs' => array( 'min' => 1, 'max' => 200, 'style' => 'width: 80px;' ),
) );
...
$wp_customize->add_control( 'theme_options[body_line_height]', array(
	'label'       => esc_html__( 'Body Line Height (Default: 28)', 'easyconsulting' ),
	'section'     => 'section_typography',
	'type'        => 'number',
	'input_attrs' => array( 'min' => 1, 'max' => 200, 'style' => 'width: 80px;' ),
) );
...
$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'theme_options[custom_theme_color]', array(
	'label'             => esc_html__( 'Main Theme Color', 'easyconsulting' ),
	'section'           => 'colors',
) ) );
...
$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'theme_options[top_bar_color]', array(
	'label'             => esc_html__( 'Top Bar Color', 'easyconsulting' ),
	'section'           => 'colors',
) ) );